                    ...
                    <div className="row align-items-center">
                        <div className="services-image">
                            <ScrollAnimation animateIn="fadeInLeft" delay={50} animateOnce={true}>
                                <div className="image">
                                    <img src="/images/svg/svgviewer-output%20(9).svg" alt="image" />
                                </div>
                            </ScrollAnimation>
                        </div>
                                ...
                                <div className="pt-30">
                                    ...
                                    >
                                        <div className="priceForm">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-lg-4 formcontrol mt-15">
                                                        <input
                                                            ...
                                                            value={this.state.destinationPincode}
                                                            autoComplete="off"
                                                            fdprocessedid="vamu0r"
                                                            onChange={(e) => this.handleChange('destinationPincode', e.target.value)}
                                                        />
                                                    </div>
                                                    <div className="col-lg-4 formcontrol mt-15">
                                                        <input
                                            ...
                                            <div className="row">
                                                <div className="align-item-center col-12 flex mt-15">
                                                    <input
                                                        type="radio"
                                                        name="add-dimension"
                                                        className="add-dimensions-radio"
                                                        id="dimensions"
                                                        defaultValue="add"
                                                        onChange={this.handleRadioChange} // Call the function on change
                                                        checked={this.state.addDimensions} // Add this line to manage the checked state
                                                    />
                                                    <label
                                                        htmlFor="dimensions"
                                                        className="add-dimensions-radio-label"
                                                        style={{
                                            ...
                                            <div className="row">
                                                <div className="col-12 flex mt-15 justify-content-space-between align-item-center flex-dir-col-mob">
                                                    ...
                                                    <button
                                                        ...
                                                        fdprocessedid="vn08s"
                                                    >
                                                        {this.state.showDetailsForm ? 'Submit' : 'Check Price'}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
