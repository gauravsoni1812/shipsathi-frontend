                                ...
                                <div className="col-12">
                                    <div className="content-wrapper">
                                        ...
                                        <p>
                                            ...
                                            provide your proper and accurate Name as per Passport / Adhaar or
                                        ...
                                        <p>
                                            You will use this Website to make only appropriate transactions for
                                        ...
                                        <p>
                                            Make sure that all information supplied by you on this Website is
                                            correct, accurate, current and complete.
                                        </p>
                                        <p>
                                            If you have an online User Account with this Website, you will
                                            safeguard your login details such as login ID and password and will
                                            supervise the same. You will be entirely responsible for any use or
                                        ...
                                        <p>
                                            ...
                                            implication connected to You, to outline, scrap, hack, information
                                            mine, remove, gather, duplicate, disperse, trade, alter, offer or
                                            transmit any substance or material from this Site, including however
                                            not restricted to any information, indexed lists, content, pictures,
                                            sound, video or connections for any business, business or open
                                            reason.
                                        </p>
                                        <p>
                                            The information and content provided on this Website including, the
                                            availability of logistics services, as well as the infrastructure
                                            used to provide such content and information, is proprietary to our
                                            Service Providers or us.
                                        </p>
                                        <p>
                                            The Customer must have the learning of all laws not restricted to
                                        ...
                                        <p>
                                            ...
                                            depiction given by the Customer on the waybill and other applicable
                                        ...
                                        <p>
                                            Protection: To obtain and keep up a protection to secure the
                                        ...
                                        <p>
                                            All the Services available on the website are governed by the rules
                                            of service and regulations of the respective Service Provider. You
                                            are requested to refer to, acquaint and abide by those standards of
                                            service and practices of the particular Service Provider, before
                                            booking any shipping with us.
                                        </p>
                                        <h3>List of prohibited items:</h3>
                                        <div className="row">
                                            <div className="col-6">
                                            ...
                                            <div className="col-6">
                                                <ul className="list-style-3">
                                                    ...
                                                    <li>Alchohol and Narcotic Substances</li>
                                        ...
                                        <ul className="list-style-3">
                                            ...
                                            <li>
                                                Early COD plan will be activated on all newly placed orders in
                                                system post plan activation.
                                            </li>
                                            <li>
                                                Once you deactivate your Early COD plan , no early COD charges
                                                will be applicable for new orders.
                                            </li>
                                            <li>
                                                In case of negative balance make sure to recharge your account to
                                                receive COD on the due date.
                                            </li>
                                            <li>
                                                In case of any breach in the provided condition your early COD
                                                charges will remain the same for delayed remittance.
                                            </li>
                                            <li>
                                                You will get the notification over email if you deactivate your
                                                plan or breach any of the above stated conditions.
                                            </li>
                                        </ul>
                                        <h4>Use of generic packing Material, </h4>
                                        <p>
                                        ...
                                        <p>
                                            In case where the merchant ships restricted products by Air/Surface
                                            mode, the entire penalty will be borne solely by the merchant.
                                        </p>
                                        <h4>Shipment Damaged </h4>
                                        <p>
                                        ...
                                        <h4>
                                            Disputes Related to Damaged / Lost / Leakage / Fake Delivery / Non
                                            receipt of Shipment
                                        </h4>
                                        <p>
                                        ...
                                        <p>
                                            The merchant must ensure that the correct product description is
                                            mentioned for the respective products, sold by them. In case of
                                            incorrect/incomplete product description shipments may get returned
                                            from origin. In such cases the shipping charges will be applicable
                                            on return orders and will be irreversible. Also, if any penalty is
                                            imposed by the government authorities during the transit of
                                            shipments, the merchant will be liable to pay the same.{" "}
                                        </p>
                                        <h4>Cod Remitted Due to Wrong delivery status</h4>
                                        <p>
                                            In case the COD amount is already remitted to the user, is
                                            identified as incorrect due to wrong delivery status updated by the
                                            courier partner, the same amount shall be deducted from their wallet
                                            amount or from future COD payments.{" "}
                                        </p>
                                        ...
                                        <h6>Carrier Risk</h6>
                                        <p>
                                            Under carrier risk- Bigship will be only liable to remit the amount
                                            which has been remitted by the carrier to Bigship.
                                        </p>
                                        <p>
                                            Under claim policy of Delhivery LTL-as amount of Rs.10,000 is to be
                                            deducted as the processing fee. After the deduction - the salvage
                                            value of the shipment (as per the carrier) will be only remitted to
                                            the clients wallet in case of insurance under carrier risk option.
                                        </p>
                                        <h6>3rd Party Insurance</h6>
                                        <p>
                                            Under 3rd party insurance - the salvage value of the shipment will
                                            be remitted as per the decision by Bigship Management and the
                                            carrier.
                                        </p>
                                    </div>
                                </div>
